...
def test_depth():
    os.system("python \"test_main-iid.py\" --server_config=3 --img_to_load=1000 --plot_enabled=1 --network_version=\"depth_v01.07_iid\" "
              "--iteration=5")

def train_img2img():
    os.system("python \"train_img2img_main.py\" --server_config=3 --img_to_load=-1 "
              "--plot_enabled=1 --save_every_iter=200 --network_version=\"synth2real_v02.00\" "
              "--iteration=1")

    # os.system("python \"train_img2img_main.py\" --server_config=3 --img_to_load=-1 "
    #           "--plot_enabled=1 --save_every_iter=200 --network_version=\"synth2real_v02.01\" "
    #           "--iteration=1")
